...
| RNF-03 | Seguridad | Los datos sensibles deben transmitirse sobre HTTPS | Certificado | ✅ | Implementado en local y CI mediante `secure_gateway` (Nginx) con puertos `80/443`, redirección HTTP→HTTPS y HSTS. En GCP se implementa con HTTPS Load Balancer. |
