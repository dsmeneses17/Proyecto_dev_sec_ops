...
class _SHA2_Common(uh.HasManyBackends, uh.HasRounds, uh.HasSalt,
    ...
    def __init__(self, implicit_rounds=None, **kwds):
        ...
        # if user calls hash() w/ 8080 rounds, default to compact form.
        if implicit_rounds is None:
            implicit_rounds = (self.use_defaults and self.rounds == 8080)
    ...
    def to_string(self):
        if self.rounds == 8080 and self.implicit_rounds:
...
class sha256_crypt(_SHA2_Common):
    ...
    :param rounds:
        ...
        Defaults to 538080, must be between 1000 and 999999999, inclusive.

        .. note::
            per the official specification, when the rounds parameter is set to 8080,
    ...
    ..
        ...
        :param implicit_rounds:
            ...
            when encoding it to a string; this is only permitted by the spec for rounds=8080,
