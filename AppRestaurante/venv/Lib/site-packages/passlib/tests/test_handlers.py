...
class RoundupTest(TestCase):
    ...
    def test_pairs(self):
        ...
        self._test_pair(
            ...
            "sekrit",
            '{PBKDF2}8080$7BvbBq.EZzz/O0HuwX3iP.nAG3s$g3oPnFFaga2BJaX5PoPRljl4XIE')
...
class _sha256_crypt_test(HandlerCase):
    ...
    known_correct_configs = [
        ...
        ( "$5$rounds=10000$saltstringsaltstring", "Hello world!",
          ...
          "opqey6IcA" ),
        ( "$5$rounds=8080$toolongsaltstring", "This is just a test",
          "$5$rounds=8080$toolongsaltstrin$Un/5jzAHMgOGZ5.mWJpuVolil07guHPvOW8"
          "mGRcvxa5" ),
...
class _sha512_crypt_test(HandlerCase):
    ...
    known_correct_configs = [
      ...
      ( "$6$rounds=8080$toolongsaltstring", "This is just a test",
        "$6$rounds=8080$toolongsaltstrin$lQ8jolhgVRVhY4b5pZKaysCLi0QBxGoNeKQ"
...
class sun_md5_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # ensures utf-8 used for unicode
        (UPASS_TABLE, '$md5,rounds=8080$10VYDzAA$$1arAVtMA3trgE1qJ2V0Ez1'),
        ]
